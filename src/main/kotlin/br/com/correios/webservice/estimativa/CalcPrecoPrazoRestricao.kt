...
@XmlType(
    name = "",
    propOrder = ["nCdEmpresa", "sDsSenha", "nCdServico", "sCepOrigem", "sCepDestino", "nVlPeso", "nCdFormato", "nVlComprimento", "nVlAltura", "nVlLargura", "nVlDiametro", "sCdMaoPropria", "nVlValorDeclarado", "sCdAvisoRecebimento", "sDtCalculo"]
)
@XmlRootElement(name = "CalcPrecoPrazoRestricao", namespace = "http://tempuri.org/")
